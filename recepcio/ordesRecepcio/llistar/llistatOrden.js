...
function obtindreOrdens() {
    ...
    arrOrden.forEach(order => {
        ...
        var textProveidor = document.createTextNode(order.supplier);
        proveidor.appendChild(textProveidor);

        var dataEstimada = document.createElement('td');
        var textDataEstimada = document.createTextNode(order.estimated_reception_date);
