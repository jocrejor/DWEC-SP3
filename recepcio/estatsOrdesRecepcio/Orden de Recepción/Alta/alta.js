...
/**
 * Crea el formulario que recolectará la información del estado de orden de recepción
 */
...
/**
 * Al momento de darle el alta al estado de ordenes de recepción existe la posibilidad de modificar el ID.
