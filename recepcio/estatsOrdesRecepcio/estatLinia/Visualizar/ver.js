...
/**
 * Crea el formulario donde se visualizarán todos los datos del estado de línea orden de recepción seleccionado
 */
...
/**
 * Carga y retorna la lista de estados de línea de ordenes de recepción almacenada en el localStorage. En caso de no haber datos devuelve un array vacío
...
/**
 * Carga el formulario con los datos del estado de línea de orden de recepción indicado en la
 * URL por el id
 */
