...
function crearIndex () {
    ...
    let h1_contenido = document.createTextNode("Estat de Línia d'Orde de Recepció");
    ...
    let btn_prov_cont   = document.createTextNode("Estats");
    btn_proveedores.setAttribute("class", "btn btn-primary btn-lg m-4");
    btn_proveedores.setAttribute("id", "estados");
