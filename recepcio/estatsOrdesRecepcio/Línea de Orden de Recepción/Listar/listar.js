...
/**
 * Crea la tabla donde se mostrarán todos los estados de línea de ordenes de recepción existentes
 */
function crearTabla() {
    // Div
    ...
    let contenido = document.createTextNode("Estat de Línia d'Orde de Recepció");
...
/**
 * Carga, ordena y devuelve la lista de estados de línea de ordenes de recepción almacenadas en el localStorage
...
/**
 * Crea las filas de las tablas con los estados de línea ordenes de recepción existentes en el localStorage
 */
...
/**
 * Esta función redirige la página a visualizar estado de orden de línea de orden recepción enviando el id por URL
...
/**
 * Esta función redirige la página a modificar estado de línea de orden recepción enviando el id por URL
 * @param {*} id recibe el id del proveedor
 */
...
/**
 * Esta función elimina el estado de línea de orden de recepción seleccionado
 * @param {*} id recibe el id del proveedor
 */
