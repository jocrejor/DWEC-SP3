...
/**
 * Inicialitza els estats de línia d'ordres de recepció des del localStorage.
...
/**
 * Crea les files de la taula amb els estats d'ordres de recepció existents.
 */
function listarEstados() {
    let estados = inicializarEstados();
    let tablaContenido = document.getElementById("tablaContenido");
    
    tablaContenido.innerHTML = ""; // Netejem el contingut previ de la taula
...
/**
 * Elimina l'estat de recepció seleccionat i actualitza la taula.
